  ...
  list: [
    {
      ...
      descriptions: [
        ...
        {
          content:
            '기업 고객 30곳 대상 수기 정산 프로세스를 카드 자동결제로 전환, 담당자 수작업 및 누락 리스크 제거',
        },
        {
          content:
        ...
        {
          content:
            '결제 상태 단계별 분리로 장애 발생 시 실패 구간부터 재처리 가능, 전체 결제 흐름 재실행 없이 복구 가능한 구조 확보',
        },
      ],
    },
    {
      ...
      descriptions: [
        ...
        { content: '구현', weight: 'BOLD' },
        {
          ...
          descriptions: [
            ...
            {
              content:
                '역할 기반 접근 제어(RBAC) 구조로 설계하여 향후 역할 추가 시 권한 설정만으로 확장 가능한 구조 확보',
            },
          ],
        },
        {
          ...
          descriptions: [
            ...
            {
              content:
                '결재 상태(요청·승인·반려·취소)를 공통 흐름으로 정의하고 문서 유형과 분리하여 유지보수 부담 최소화',
            },
          ],
        },
        {
        ...
        {
          content:
            '공통 결재 프로세스 추상화로 신규 결재 문서 추가 시 기존 코드 수정 없이 확장 가능, 추가 개발 비용 최소화',
        },
        {
          content:
